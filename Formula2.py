...
def main():
    ...
    file_path = 'D:/rejectGmailPY/testing.xlsx'
    required_columns = ['email', 'name', 'Committee', 'Strengths', 'Areas for Improvement']
    ...
    for index, row in df_cleaned.iterrows():
        ...
        # Rejection email body with recipient's name, committee, and feedback
        body = f"""
        <html>
          <body style="background-color: #0f212b; color: #ffffff; font-family: Arial, sans-serif; padding: 20px; position: relative;">
            ...
            <p>Here are some of your highlighted <strong style="color:#ffc222;"> strengths:</p>
            <p>{strengths}</p>
            <p>However, we believe you could benefit from working on the<strong style="color:#ffc222;"> following areas: </strong></p>
